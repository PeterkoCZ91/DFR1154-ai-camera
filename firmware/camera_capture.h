...
// Pending sensor values for PENDING_FLAG_SETTINGS.
// Written by HTTP handlers (under settings_mutex), read+cleared by captureTask.
// Use -1 as "not set" sentinel for int fields; -1 for bool fields too.
struct PendingSensorSettings {
    int vflip;       int hmirror;
    int brightness;  int contrast;   int saturation;
    int sharpness;   int denoise;
    int aec;         int aec2;       int ae_level;   int aec_value;
    int agc;         int agc_gain;   int gainceiling;
    int awb;         int awb_gain;   int wb_mode;
    int quality;
};
#define PSV_NONE INT_MIN  // sentinel: field not changed
